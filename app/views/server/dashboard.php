...
<body>
    <nav class="navbar navbar-light navbar-expand-md py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
                    ...
                    </svg></span><span>(APP NAME)</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-3"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
    ...
    <div class="container py-4 py-xl-5" style="color: #212567;">
        <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
            <div class="col">
                <div class="text-center d-flex flex-column align-items-center align-items-xl-center">
                    ...
                    <div class="px-3">
                        <h4 style="color: rgb(33,37,41);">Site Visits&nbsp;</h4>
                        <p style="color: #6c7592;font-size: 50px;">N/A</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="text-center d-flex flex-column align-items-center align-items-xl-center">
                    <div class="bs-icon-lg bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block mb-3 bs-icon lg">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person">
                            <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM8 9a5 5 0 0 0-5 5v.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V14a5 5 0 0 0-5-5z"></path>
                        </svg>
                    </div>
                    <div class="px-3">
                        <h4 style="color: rgb(33,37,41);">Users</h4>
                        <p style="color: #6c7592;font-size: 50px;"><?= isset($totalUsers) && $totalUsers > 0 ? $totalUsers : 0 ?></p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="text-center d-flex flex-column align-items-center align-items-xl-center">
                    <div class="bs-icon-lg bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block mb-3 bs-icon lg">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-file-earmark-text">
                            <path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5L14 4.5zM9.5 2H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V5.5H9.5V2z"/>
                            <path d="M5 7h6v1H5V7zm0 2h6v1H5V9zm0 2h6v1H5v-1z"/>
                        </svg>
                    </div>
                    <div class="px-3">
                        <h4 style="color: rgb(33,37,41);">Articles</h4>
                        <p style="color: #6c7592;font-size: 50px;"><?= isset($totalArticles) && $totalArticles > 0 ? $totalArticles : 0 ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid" style="border-style: none;">
        <div class="row" style="border-style: none;">
            <div class="col-12 col-sm-6 col-md-6" style="border-style: none;margin: auto;">
                <h3 class="text-dark mb-4" style="border-style: none;text-align: center;font-size: 40px;">Logs&nbsp;</h3>
            </div>
        </div>
        <div class="card" id="TableSorterCard" style="border-style: none;">
            <div class="row" style="border-style: none;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table tablesorter" id="ipi-table">
                            <thead class="thead-dark">
                                <tr>
                                    <th class="fs-6 fw-normal text-center">TimeStamp</th>
                                    <th class="fs-6 fw-normal text-center">Name</th>
                                    <th class="fs-6 fw-normal text-center">Description</th>
                                </tr>
                            </thead>
                            <tbody class="text-center">
                                <tr>
                                    <td>10/10/2024 2:33PM<br></td>
                                    <td>Mr. Squidward</td>
                                    <td>Article:&nbsp;<span style="color: rgb(100, 107, 107);">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</span><br></td>
                                </tr>
                                <tr>
                                    <td>10/11/2024 4:26PM</td>
                                    <td>Kaedera Kazuha</td>
                                    <td>Article:&nbsp;<span style="color: rgb(100, 107, 107);">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</span><br></td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <footer class="text-center">
                <div class="container text-muted py-4 py-lg-5">
                    <ul class="list-inline">
                        <li class="list-inline-item me-4"><a class="link-secondary" href="#">Forums</a></li>
                        <li class="list-inline-item me-4"><a class="link-secondary" href="#">Categories</a></li>
                        <li class="list-inline-item"><a class="link-secondary" href="#">Homepage</a></li>
                    </ul>
                    <ul class="list-inline">
                    ...
                    <p class="fw-normal mb-0" style="color: rgb(35,39,41);">Copyright © 2024 (APP NAME)</p>
                </div>
            </footer>
        </div>
    </footer>
